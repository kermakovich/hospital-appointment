...
import solvd.laba.ermakovich.ha.domain.exception.AppointmentNotExistException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AppointmentNotExistException.class)
    ...
    @ExceptionHandler({EmailAlreadyExistsException.class, AppointmentIsBusyException.class, WrongAppointmentTimeException.class})
